...
function ArchiveSubmitModal({ rows, archiveSubmitOpen, setArchiveSubmitOpen, currentUser, parts, archiveDecisions, setArchiveDecisions, setQueueTasks }) {
