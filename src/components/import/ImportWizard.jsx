...
function ImportWizard() {
  ...
  const { page, setPage, parts, rawParts, setRawParts, rawAudit, setRawAudit, _supaWrite,
    ...
    if (importStep === 0 || !importFile) {
      var recentImps = (function(){ var seen = {}; return (rawAudit||[]).filter(function(a){ if (a.action !== 'IMPORT COMMIT') return false; var key = (a.target || a.fileName || a.name || '').trim().toLowerCase(); if (seen[key]) return false; seen[key] = true; return true; }); })().slice(0,5);
